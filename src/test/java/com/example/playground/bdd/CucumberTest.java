...
@ConfigurationParameters({
        ...
        @ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.example.playground.bdd.steps"),
        // @ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "not @Disabled and @wip"),
